...
import { getDetailVoucer } from '../../services/player';
...
function Detail() {
  ...
  const getVoucerDetailAPI = useCallback(async (id) => {
    const data = await getDetailVoucer(id);
