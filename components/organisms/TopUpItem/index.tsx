...
export default function TopUpItem(props: TopUpItemProps) {
  ...
  // const ROOT_IMG = process.env.NEXT.PUBLIC_IMG;
  ...
  return (
    <div className="row align-items-center">
      <div className="col-md-12 col-4">
        <img src={`https://api-bwa-storegg.herokuapp.com/uploads/${data.thumbnail}`} width="280" height="380" className="img-fluid" alt="" />
      </div>
